...
Article.create!(title: 'Agradecimentos à Cassia', short_title: 'Agradecimentos à Cassia', image_url: File.open(File.join(Rails.root, 'db', 'seed_images', 'item1.jpg')), content: 'Hello World')
